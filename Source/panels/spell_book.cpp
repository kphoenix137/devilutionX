...
SpellID SpellPages[6][7] = {
	...
	{ SpellID::LightningWall, SpellID::Immolation, SpellID::Warp, SpellID::Reflect, SpellID::Berserk, SpellID::RingFire, SpellID::Search },
...
spell_type GetSBookTrans(SpellID ii, bool townok)
{
	...
	if (townok && leveltype == DTYPE_TOWN && st != RSPLTYPE_INVALID && !spelldata[static_cast<int8_t>(ii)].sTownSpell) {
		st = RSPLTYPE_INVALID;
	}
