...
enum class ItemMiscID : int8_t {
	...
	PotionFullHealing,
	PotionHealing,
	PotionSeriousHealing, // Unused
	PotionDeadlyHealing, // Unused
	PotionMana,
	PotionFullMana,
	PotionExperience, // Unused
	PotionExperienceCurse, // Unused
	ElixirStrength,
	ElixirMagic,
	ElixirDexterity,
	ElixirVitality,
	ElixirStrengthCurse,  // Unused
	ElixirMagicCurse,  // Unused
	ElixirDexterityCurse, // Unused
	ElixirVitalityCurse, // Unused
	PotionRejuvenation,
	PotionFullRejuvenation,
	UseLast,
	Scroll,
