...
enum inv_item : int8_t {
	...
	INVITEM_AMULET_LEFT  = 3,
	INVITEM_AMULET_RIGHT = 4,
	INVITEM_HAND_LEFT    = 5,
	INVITEM_HAND_RIGHT   = 6,
	INVITEM_CHEST        = 7,
	INVITEM_INV_FIRST    = 8,
	INVITEM_INV_LAST     = 47,
	INVITEM_BELT_FIRST   = 48,
	INVITEM_BELT_LAST    = 55,
	// clang-format on
};
...
enum inv_xy_slot : uint8_t {
	...
	SLOTXY_RING_LEFT      = 1,
	SLOTXY_RING_RIGHT     = 2,
	SLOTXY_AMULET_LEFT    = 3,
	SLOTXY_AMULET_RIGHT   = 4,
	SLOTXY_HAND_LEFT      = 5,
	SLOTXY_HAND_RIGHT     = 6,
	SLOTXY_CHEST          = 7,
	...
	SLOTXY_INV_ROW1_LAST  = 17,
	SLOTXY_INV_ROW2_FIRST = 18,
	SLOTXY_INV_ROW2_LAST  = 27,
	SLOTXY_INV_ROW3_FIRST = 28,
	SLOTXY_INV_ROW3_LAST  = 37,
	SLOTXY_INV_ROW4_FIRST = 38,
	SLOTXY_INV_ROW4_LAST  = 47,
	SLOTXY_INV_LAST       = SLOTXY_INV_ROW4_LAST,

	// belt items
	SLOTXY_BELT_FIRST     = 48,
	SLOTXY_BELT_LAST      = 55,
	NUM_XY_SLOTS          = 56
	// clang-format on
};
